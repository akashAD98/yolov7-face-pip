...
if __name__ == '__main__':
    ...
    YOLOv7_face_detector = YOLOv7_face_detector(modelpath='yolov7-face.onnx.pt', conf_thres=0.45, iou_thres=0.5)

    # Detect Objects
    boxes, scores, kpts = YOLOv7_face_detector.detect(srcimg)

    # Draw detections
    results = YOLOv7_face_detector.draw_detections(srcimg, boxes, scores, kpts)
